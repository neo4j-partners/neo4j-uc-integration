...
Usage:
    ./upload.sh run_04_metadata_sync_tables.py && ./submit.sh run_04_metadata_sync_tables.py
"""
...
parser.add_argument("--metadata-catalog", required=True, help="Target catalog for materialized tables")
parser.add_argument("--nodes-schema", default="nodes", help="Schema for node label tables")
parser.add_argument("--relationships-schema", default="relationships", help="Schema for relationship tables")
args, _ = parser.parse_known_args()
cfg = derive_config(args)

TARGET_CATALOG = args.metadata_catalog
NODES_SCHEMA = args.nodes_schema
RELS_SCHEMA = args.relationships_schema
