...
Genie spaces support instructions (example SQL, plain text) that teach the LLM the domain and JOIN patterns. Add the following to the Genie space instructions:
...
* https://github.com/neo4j-partners/neo4j-uc-integration/blob/main/getting-started/03-materialized-tables.ipynb[03-materialized-tables.ipynb] -- materialization notebook
